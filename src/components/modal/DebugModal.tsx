...
export default function DebugModal({
    ...
    const [form, setForm] = useState({
        ...
        productId: "",
        status: "available",
        variations: [{ id: "", label: "", price: 0, uuid: "" }],
        username: "",
    });

    return (
        <Modal
            isOpen={isOpenModalId === "debug"}
        ...
        >
            ...
            >
                ...
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        addProduct(form.username, form);
                        console.log("フォームデータ送信: ", form);
                    }}
                >
                    <div className="mb-4">
                            ...
                            <div key={index} className="mb-2">
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        newVariations[index].price = Number(
                                            e.target.value
                                        );
                                        setForm({
                                            ...form,
